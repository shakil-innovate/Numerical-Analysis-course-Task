...
void shakil(){
  ld a1=1.0/6.0,a2=2.0/6.0,a3=2.0/6.0,a4=1.0/6, p1=1.0/2.0 , q11=1.0/2.0 , p2=1.0/2 , q21=0, q22=1.0/2, p3=1.0,q31=0.0 , q32=0.0 , q33=1;
  ld h=.1;
  ld x=0,y=1;
  ld lm_x=4;
  ...
  while(x<lm_x){
    ...
    ld k4=dif_eq(x+p3*h,y+q31*k1*h+q32*k2*h + q33*k3*h);
